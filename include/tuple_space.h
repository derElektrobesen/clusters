...
#define TUPLE_SPACE_TYPE_DEDUCTOR(__, _index, __ref_supported) ({ \
	...
	__tuple_space_convertors[(!__ref_supported \
		...
		__TUPLE_SPACE_GET_TYPE(__element_##_index)](__real_tuple + _index, &__element_##_index); \
});
...
#define tuple_space_out(...) __tuple_space_wrapper(__tuple_space_out, ##__VA_ARGS__)
